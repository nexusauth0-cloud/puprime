  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        "border-zinc-700/50 bg-zinc-900 text-zinc-100",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-lg border border-zinc-700 bg-transparent px-3 text-sm font-medium hover:bg-zinc-800 transition-colors",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute top-2 right-2 rounded-md p-1 text-zinc-500 hover:text-zinc-300 transition-colors",
      className
    )}
    toast-close=""
    {...props}
